...
public class Forms_retrieve extends HttpServlet { 
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{			
			if (((JSONObject)jsonObj.get(i)).get("Tab_Name").equals("Target")||((JSONObject)jsonObj.get(i)).get("Tab_Name").equals("Selection")||((JSONObject)jsonObj.get(i)).get("Tab_Name").equals("ciblage")) //HARD CODED
			{
