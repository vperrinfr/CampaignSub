...
$(document).on("click", "#submit", function () {
    ...
    $(location).attr('href','app.jsp?pdv='+$("#inputEmail").val() + '&user=asm_admin&password=demo#portfolio');
   });
...
<body id="page-top" class="index">
    ...
    <header>
        ...
        <h2 class="form-signin-heading">Enter your local store ID</h2>
        <label for="labelinputEmail" class="sr-only">ID: </label>
